...
function childrenTakeAllStringContents(element: ReactNode): string {
  if (typeof element === "string" || typeof element === "number") {
    return String(element)
  }

  if (React.isValidElement<{ children?: ReactNode }>(element)) {
    return childrenTakeAllStringContents(element.props.children)
  }
...
const COMPONENTS: Components = {
  ...
  code: ({ children, className, node: _node, ...rest }: CodeProps) => {
...
function withClass(Tag: React.ElementType, classes: string) {
  const Component = ({
    ...
    return <Tag className={cn(classes, props.className)} {...props} />
  }
  Component.displayName = typeof Tag === "string" ? Tag : "MarkdownElement"
  return Component
}
