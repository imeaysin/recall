          ...
          <LandingContainer size="legal">
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="font-serif text-2xl leading-tight text-foreground sm:text-3xl lg:text-3xl lg:leading-tight xl:text-3xl xl:leading-[1.3] 2xl:text-3xl 3xl:text-4xl">
                  {document.title}
                </h1>
