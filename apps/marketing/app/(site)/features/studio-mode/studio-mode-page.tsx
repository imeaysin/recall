    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Yes, Studio Mode is available as part of the Theo desktop application for both macOS (Intel and Apple Silicon) and Windows.",
        },
        {
          question: "How does pricing work for Studio Mode?",
          answer:
            "Studio Mode is completely free for personal usage. For commercial usage, you need the Desktop License, which is included with Theo Pro or can be purchased separately.",
        },
      ],
    },
    video: {
      ...
      iframe: {
        src: "https://theo.example/embed/qk8gt56e1q1r735",
        title: "Studio Mode Demo - Theo Screen Recording",
      },
    },
    cta: {
      title: "Start Creating Professional Content Today",
      description:
        "Download Theo and experience the power of Studio Mode for yourself. Create stunning, professional-quality recordings that engage your audience.",
      primaryButton: "Download Theo Free",
