...
const InboxMatchAnimation = dynamic(() =>
  import("@/components/animations/inbox-match-animation").then(
    (m) => m.InboxMatchAnimation
  )
)
const InvoicePaymentAnimation = dynamic(() =>
  import("@/components/animations/invoice-payment-animation").then(
    (m) => m.InvoicePaymentAnimation
  )
)
const TransactionFlowAnimation = dynamic(() =>
  import("@/components/animations/transaction-flow-animation").then(
