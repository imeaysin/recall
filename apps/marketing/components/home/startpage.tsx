...
const InboxMatchAnimation = dynamic(() =>
  import("@workspace/ui/components/animations/inbox-match-animation").then(
    (m) => m.InboxMatchAnimation
  )
)
const InvoicePaymentAnimation = dynamic(() =>
  import("@workspace/ui/components/animations/invoice-payment-animation").then(
    (m) => m.InvoicePaymentAnimation
  )
)
const TransactionFlowAnimation = dynamic(() =>
  import("@workspace/ui/components/animations/transaction-flow-animation").then(
...
const FeaturesGridSection = dynamic(() =>
  import("@/components/home/home-sections").then(
    (m) => m.HomeFeaturesGridSection
  )
)
const TimeSavingsSection = dynamic(() =>
  import("@/components/sections/time-savings-section").then(
    (m) => m.TimeSavingsSection
  )
)
const PreAccountingSection = dynamic(() =>
  import("@/components/sections/pre-accounting-section").then(
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="z-20 flex flex-1 flex-col items-center justify-center space-y-8 px-3 sm:px-4 md:justify-start md:pt-16 lg:mx-auto lg:mb-12 lg:w-full lg:max-w-[1400px] lg:flex-none lg:space-y-0 lg:px-0 lg:pt-48 xl:mb-12 2xl:mb-12 3xl:mb-16">
            <div className="flex w-full flex-col items-center space-y-6 text-center lg:space-y-8">
              <div className="mx-auto max-w-3xl space-y-5 px-2 lg:space-y-6 lg:px-0 3xl:max-w-5xl">
                ...
                <p className="mx-auto max-w-xl font-sans text-base leading-relaxed text-muted-foreground lg:text-lg">
              ...
              <div className="flex flex-col items-center gap-3 pt-2">
                ...
                >
                  <span className="text-sm text-inherit">Start your trial</span>
                </Button>
                ...
                <div className="flex items-center justify-center gap-3 pt-4">
                  <div className="flex items-center gap-2.5">
                    <Link
                      href="/mcp/claude"
                      className="text-muted-foreground opacity-40 transition-all duration-200 hover:text-[#D97757] hover:opacity-100"
                    >
                      <svg
                    ...
                    <Link
                      href="/mcp/chatgpt"
                      className="text-muted-foreground opacity-40 transition-all duration-200 hover:text-foreground hover:opacity-100"
                    >
                      <svg
                        className="h-[18px] w-[18px]"
                        viewBox="0 0 24 24"
                    ...
                    <Link
                      href="/mcp/perplexity"
                      className="text-muted-foreground opacity-40 transition-all duration-200 hover:text-[#20808D] hover:opacity-100"
                    >
                      <svg
                        className="h-[18px] w-[18px]"
                        viewBox="0 0 24 24"
                    ...
                    <Link
                      href="/mcp/raycast"
                      className="text-muted-foreground opacity-40 transition-all duration-200 hover:text-[#FF6363] hover:opacity-100"
                    >
                      <svg
                        className="h-[18px] w-[18px]"
                        viewBox="0 0 24 24"
                    ...
                    <Link
                      href="/mcp/manus"
                      className="text-muted-foreground opacity-40 transition-all duration-200 hover:text-[#34322D] hover:opacity-100 dark:hover:text-white"
                    >
                      <svg
                        className="h-[18px] w-[18px]"
                        viewBox="0 0 60 60"
      ...
      {isVideoModalOpen && (
        ...
        >
          <div
            className="fixed inset-0 bg-white/40 backdrop-blur-sm transition-opacity duration-200 dark:bg-black/40"
                  ...
                  <div className="flex gap-4">
                    {videos.map((video, index) => (
                      <div key={video.id} className="flex items-stretch">
                        {index > 0 && <div className="mr-4 w-px bg-border" />}
                        <button
                          type="button"
                          onClick={(e) => {
                            ...
                            if (index < videos.length - 1) {
                              ...
                              if (isLastVisible) {
                                ...
                                if (nextTag) {
                                  ...
                                  const scrollAmount =
                                    nextTagRect.right - containerRect.right + 20 // 20px padding
        ...
        <div className="mx-auto max-w-[1400px]">
            ...
            {features.map((feature, index) => (
              <div key={index.toString()} className="space-y-6 sm:space-y-8">
                <div className="space-y-2 text-center">
                  ...
                  <p className="mx-auto max-w-md font-sans text-base leading-normal text-muted-foreground">
          ...
          <div className="hidden grid-cols-1 gap-8 lg:grid lg:h-[740px] lg:grid-cols-2 lg:gap-16">
            <div className="flex gap-6">
              ...
              <div className="flex flex-1 flex-col justify-center space-y-5 lg:space-y-6">
                ...
                {features.map((feature, index) => (
                  ...
                  >
                    {activeFeature === index ? (
                      <div className="animate-[fadeInBlur_0.35s_ease-out_forwards] overflow-hidden">
                        <h2 className="max-w-md font-sans text-lg text-primary transition-colors duration-300 lg:text-xl">
                          {feature.title}
                        </h2>
                        <p className="mt-1 max-w-md font-sans text-sm leading-relaxed text-primary">
                          {feature.subtitle}
                        </p>
                      </div>
                    ) : (
            ...
            <div className="relative flex h-full items-center justify-center overflow-hidden border border-border bg-background p-6 lg:p-8">
              <div
                key={activeFeature}
                className="relative z-10 flex h-[500px] w-[400px] animate-[fadeInScale_0.4s_ease-out_forwards] items-center justify-center overflow-hidden sm:h-[640px] sm:w-[520px] lg:h-[700px] lg:w-[600px]"
