      ...
      <div className="relative z-10 w-full px-5 pt-24 pb-36">
        ...
        >
          ...
          <motion.p
            ...
            custom={2}
          >
            Level up your presentations and portfolio with 30% off Theo&apos;s
        ...
        >
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
              ...
              collaborating with classmates, Theo helps you create professional
          ...
          <div className="relative z-10 mx-auto flex h-full flex-col items-center justify-center">
            <div className="mx-auto mb-8 max-w-4xl text-center">
              ...
              <p className="text-lg text-muted-foreground">
                Join thousands of students already using Theo to create amazing
                content
              </p>
            </div>
