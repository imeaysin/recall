...
export const dailyStandupSoftwareContent: SeoPageContent = {
  ...
  featuresTitle: "Why Theo is the Ideal Daily Standup Software",
  featuresDescription:
    "Theo provides everything Agile teams need for efficient, asynchronous daily standups",
  ...
  features: [
    ...
    },
    {
      ...
      description:
        "Ensure sensitive project discussions remain confidential with Theo's open-source approach and custom S3 storage options for complete data ownership and NDA compliance.",
    },
    {
  ...
  useCasesTitle: "How Agile Teams Use Theo for Daily Standups",
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "We recommend keeping recordings under 3 minutes per person, focusing on the classic standup format: what was accomplished, what's planned for today, and any blockers. Theo's Instant Mode is perfectly optimized for these quick updates, while Studio Mode offers more flexibility for complex situations.",
    },
    {
      question: "Can we integrate Theo with our project management tools?",
      answer:
        "Theo provides easy-to-share links that work seamlessly with all major project management and communication platforms including Jira, Trello, Slack, Microsoft Teams, and more. Simply copy the link to your standup recording and paste it into your team's preferred tools.",
    },
    {
      question: "What if someone misses recording their standup?",
      answer:
        "Theo's flexibility is perfect for occasional missed standups. Team members can record updates when they're available, and others can easily access the recording later. This is actually an advantage over traditional standups, where missing the meeting means missing the information completely.",
    },
    {
  ...
  comparisonTable: {
    title: "Theo vs. Traditional Standup Methods",
    headers: ["Feature", "Theo", "Video Meetings", "Text-Based Standup Tools"],
    rows: [
      [
  ...
  migrationGuide: {
    title: "How to Implement Theo for Your Daily Standups",
    steps: [
  ...
  video: {
    ...
    alt: "Theo screen recorder demonstration for daily standup meetings",
  },
