...
export const onlineClassroomToolsContent: SeoPageContent = {
  ...
  featuresTitle: "Why Theo is Essential for Modern Online Classrooms",
  featuresDescription:
    "Theo provides educators with powerful tools for creating engaging, accessible asynchronous learning experiences",
  ...
  features: [
    ...
    },
    {
      ...
      description:
        "Maintain complete control over sensitive student data with Theo's open-source approach and custom S3 storage options. Create a branded classroom experience with custom domain integration for institutional cohesion.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Record, edit and share lessons in minutes rather than hours. Educators report saving 3-5 hours weekly by replacing traditional content creation methods with Theo's streamlined recording process.",
    },
    {
  ...
  useCasesTitle: "How Educators Use Theo in Virtual Classrooms",
  ...
  faqs: [
    {
      ...
      answer:
        "Yes, students can use Theo to record project presentations, assignments, and peer teaching materials. This is particularly valuable for speech, language, performance, and demonstration-based assessments where text submission doesn't capture the student's full capabilities.",
    },
    {
      question: "How many recordings can I store?",
      answer:
        "Theo's free plan includes generous storage for individual educators. For departmental or institution-wide implementation, our paid plans offer expanded storage options, and you can connect your own S3 storage for unlimited self-managed content retention and complete data ownership.",
    },
    {
      question: "Is Theo suitable for K-12 vs. university-level teaching?",
      answer:
        "Theo is designed for versatility across all educational levels. K-12 educators appreciate the simplicity and privacy controls, while university instructors leverage the professional-quality recording capabilities for complex subject matter. The platform scales with the complexity of your content needs.",
    },
    {
      question: "Does Theo integrate with existing LMS platforms?",
      answer:
        "Theo provides easy-to-share links and embed codes that work seamlessly with all major Learning Management Systems including Canvas, Blackboard, Moodle, Google Classroom, and more. Simply copy the link to your recording and paste it into your course materials.",
    },
    {
      question: "How does Theo improve accessibility for diverse learners?",
      answer:
        "Theo supports diverse learning needs by allowing students to control playback speed, pause and review content as needed, and access materials at times that accommodate their individual circumstances. For institutions with specific accessibility requirements, Theo's open-source nature allows for custom adaptations.",
    },
  ],

  comparisonTable: {
    title: "Theo vs. Traditional Online Teaching Methods",
    headers: ["Feature", "Theo", "Video Meetings", "Text & Slide Materials"],
    rows: [
      [
  ...
  migrationGuide: {
    title: "How to Implement Theo in Your Classroom",
    steps: [
      "Download Theo for your operating system (Mac and Windows)",
  ...
  video: {
    ...
    alt: "Theo screen recorder demonstration for online classroom teaching",
  },
