...
export const remoteTeamCollaborationContent: SeoPageContent = {
  ...
  featuresTitle: "Why Theo is Perfect for Remote Team Collaboration",
  featuresDescription:
    "Theo provides everything distributed teams need for seamless async communication and collaboration",
  ...
  features: [
    ...
    },
    {
      ...
      description:
        "Share sensitive information with confidence. Theo's open-source nature and custom S3 storage options ensure your team's communications remain private and secure at all times.",
    },
    {
  ...
  useCasesTitle: "How Remote Teams Use Theo",
  useCasesDescription:
  ...
  faqs: [
    {
      question: "How does Theo help remote teams collaborate more effectively?",
      answer:
        "Theo enables asynchronous visual communication that eliminates time zone constraints. Team members can record detailed screen captures with webcam overlay, share them instantly, and collect feedback through threaded comments—all without scheduling meetings. This typically saves teams 30+ minutes per person daily and improves information clarity.",
    },
    {
      question:
        "Can my entire remote team use Theo on different operating systems?",
      answer:
        "Yes, Theo works seamlessly across both Mac and Windows, ensuring your entire distributed team can collaborate regardless of their device preferences. The experience remains consistent across platforms with the same features available to everyone.",
    },
    {
      question:
        "How secure are the recordings for sensitive company information?",
      answer:
        "Theo prioritizes security and privacy with its open-source approach, allowing for complete transparency about how your data is handled. You can connect your own S3 storage and custom domain for complete data ownership, ensuring sensitive company information remains under your control.",
    },
    {
      question: "Does Theo integrate with other remote collaboration tools?",
      answer:
        "Theo provides easy-to-share links that work with all major communication platforms like Slack, Microsoft Teams, Notion, Trello, and more. Simply copy the link to your recording and paste it into your team's preferred tools for seamless workflow integration.",
    },
    {
      question: "Can I track who has viewed my team's recordings?",
      answer:
        "Yes, Theo's paid plans include view tracking and analytics, allowing team leads to see who has watched each recording and for how long. This helps ensure important information is reaching all team members and identifies content that may need follow-up.",
    },
  ],

  comparisonTable: {
    title: "Theo vs. Traditional Remote Collaboration Methods",
    headers: ["Feature", "Theo", "Video Meetings", "Text-Based Communication"],
    rows: [
      [
  ...
  migrationGuide: {
    title: "How to Implement Theo for Your Remote Team",
    steps: [
      "Download Theo for all team members' operating systems (Mac and Windows)",
      ...
      "Integrate Theo links into your existing workflow tools (Slack, Teams, etc.)",
  ...
  video: {
    ...
    alt: "Theo screen recorder demonstration for remote team collaboration",
  },
