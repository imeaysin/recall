...
export const employeeOnboardingContent: SeoPageContent = {
  ...
  featuresTitle: "Why Theo is the Ideal Employee Onboarding Platform",
  featuresDescription:
    "Theo provides everything HR and People Ops teams need to create an efficient, engaging onboarding experience",
  ...
  features: [
    ...
    },
    {
      ...
      description:
        "Ensure sensitive HR content and company information remains secure with Theo's open-source approach and custom S3 storage options for complete data ownership.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Theo offers a powerful onboarding tool at a fraction of the cost of specialized HR platforms, with a free tier that's perfect for smaller organizations.",
    },
    {
  ...
  useCasesTitle: "How HR Teams Use Theo for Onboarding",
  useCasesDescription:
  ...
  faqs: [
    {
      question: "Is Theo secure enough for confidential HR data?",
      answer:
        "Yes, Theo prioritizes security with its open-source approach that provides complete transparency about data handling. You can connect your own S3 storage and custom domain for complete data ownership, ensuring sensitive HR information and company procedures remain under your control.",
    },
    {
      question: "How do we organize multiple training sessions for new hires?",
      answer:
        "Theo makes organizing training content simple with customizable folders and collections. HR teams can create dedicated onboarding libraries with categorized videos for different departments or roles, making it easy for new hires to find the right training materials when they need them.",
    },
    {
      question: "Can new hires comment in real-time on training videos?",
      answer:
        "Yes, Theo's built-in threaded comment system allows new employees to ask questions or provide feedback directly on specific timestamps of training videos. HR teams and managers receive notifications and can respond asynchronously, creating a seamless Q&A experience without scheduling additional meetings.",
    },
    {
      question:
        "Does Theo integrate with Slack or Teams for onboarding updates?",
      answer:
        "Theo provides easy-to-share links that work seamlessly with all major communication platforms including Slack, Microsoft Teams, and HR tools. Simply copy the link to your onboarding video and paste it into your company's preferred communication channels for immediate access.",
    },
    {
      question: "How can Theo reduce our onboarding time and costs?",
      answer:
        "Theo typically reduces onboarding time by 40-60% by eliminating repetitive live training sessions and creating reusable video resources. HR teams save 5-10 hours per new hire, while also improving training consistency and reducing the time managers spend answering the same questions repeatedly.",
    },
  ],

  comparisonTable: {
    title: "Theo vs. Traditional Employee Onboarding Platforms",
    headers: [
      "Feature",
      "Theo",
  ...
  migrationGuide: {
    title: "How to Implement Theo for Employee Onboarding",
    steps: [
      "Download Theo for your HR team (available on Mac and Windows)",
  ...
  video: {
    ...
    alt: "Theo screen recorder demonstration for employee onboarding",
  },
