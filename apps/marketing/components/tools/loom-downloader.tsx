      ...
      <div className="flex flex-col gap-1">
        <div className="flex items-center gap-2">
          ...
          <p className="text-sm font-semibold text-muted-foreground sm:text-base">
            Switch from Loom to Theo — save 20%
          </p>
        </div>
        <p className="text-xs leading-relaxed text-muted-foreground sm:text-sm">
          ...
          at checkout for 20% off Theo Pro.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-5 rounded-2xl border border-primary bg-gradient-to-br from-primary/20 to-white p-5 sm:p-7">
        <div className="flex flex-col gap-2">
          ...
          <h3 className="text-lg font-semibold text-foreground sm:text-xl">
            Bring your whole Loom library to Theo
          </h3>
          <p className="text-sm leading-relaxed text-muted-foreground sm:text-base">
            Skip the one-by-one downloads. Theo Pro&apos;s built-in Loom
            importer transfers your entire Loom workspace to Theo in a single
            click — titles, transcripts, and all. Use{" "}
            <span className="font-mono font-semibold text-primary">
              {MIGRATE_PROMO_CODE}
            </span>{" "}
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-3 border-t border-border pt-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        >
          Import Loom videos with Theo Pro
          <svg
            className="h-3 w-3"
            fill="none"
            viewBox="0 0 24 24"
