...
export function TransactionFlowAnimation({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="relative z-10 border-b border-border px-2 pt-2 pb-1.5 md:px-3 md:pt-3 md:pb-2">
          ...
          >
            <thead className="sticky top-0 z-10 border-b border-border bg-secondary">
              <tr className="h-[28px] md:h-[32px]">
                <th className="w-[60px] border-r border-border px-1.5 text-left text-[10px] font-medium text-muted-foreground md:w-[70px] md:px-2 md:text-[11px]">
                  Date
                </th>
                <th className="w-[140px] border-r border-border px-1.5 text-left text-[10px] font-medium text-muted-foreground md:w-[160px] md:px-2 md:text-[11px]">
                  Description
                </th>
                ...
                <th className="w-[110px] px-1.5 text-left text-[10px] font-medium text-muted-foreground md:w-[120px] md:px-2 md:text-[11px]">
                  Category
                </th>
              </tr>
            </thead>
            <tbody>
              {transactions.map((transaction, index) => (
                ...
                >
                  <td className="w-[60px] border-r border-border px-1.5 text-[10px] text-muted-foreground md:w-[70px] md:px-2 md:text-[11px]">
                    {transaction.date}
                  </td>
                  <td
                    className={`w-[140px] border-r border-border px-1.5 text-[10px] md:w-[160px] md:px-2 md:text-[11px] ${
                  ...
                  <td
                    className={`w-[90px] border-r border-border px-1.5 text-[10px] md:w-[100px] md:px-2 md:text-[11px] ${
                      transaction.amount > 0
                        ? "text-[#4CAF50]"
                        : "text-foreground"
                    }`}
