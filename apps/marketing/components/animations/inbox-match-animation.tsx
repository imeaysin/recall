    ...
    <div ref={containerRef} className="relative flex h-full w-full flex-col">
      <div className="px-2 pt-2 pb-1 md:px-3 md:pt-3">
        <div className="mb-2 flex items-center justify-between md:mb-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Filter className="text-sm text-muted-foreground" size={16} />
            </button>
          </div>
        </div>
          ...
          {items.slice(1).map((item, idx) => (
            ...
            >
              <div className="flex items-start gap-1.5 md:gap-2">
                <span className="inline-flex h-5 w-5 shrink-0 items-center justify-center border border-border bg-secondary md:h-6 md:w-6">
                  <DynamicIcon
                    name={item.icon}
      ...
      >
        <div className="flex w-full items-center justify-between gap-2 border border-border bg-secondary px-2 py-2 md:px-3 md:py-3">
          ...
          <button
            type="button"
            className="ml-2 flex h-7 shrink-0 items-center justify-center border border-border bg-transparent px-2 text-[11px] text-foreground transition-colors hover:bg-muted md:ml-3 md:h-8 md:px-3 md:text-[12px]"
          >
            Review
          </button>
        </div>
