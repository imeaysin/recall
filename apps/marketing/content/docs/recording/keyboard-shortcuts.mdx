...
summary: "Keyboard shortcuts for Theo Desktop"
tags: "Recording, Desktop"
---

Theo Desktop supports keyboard shortcuts to speed up your recording workflow. You can start, stop, and control recordings without clicking any buttons, making it easy to capture your screen while staying in your flow.
...
| Action           | macOS             | Windows            |
| ---------------- | ----------------- | ------------------ |
| Open Theo        | `Cmd + Shift + 1` | `Ctrl + Shift + 1` |
| Open Preferences | `Cmd + ,`         | `Ctrl + ,`         |

## How Global Shortcuts Work

Theo's keyboard shortcuts are **global**, meaning they work even when Theo is not the focused application. You can be working in any app, press the shortcut, and Theo will respond. This is especially useful for:
...
2. Check that **Theo** is listed and enabled.
3. If Theo is not listed, click the **+** button and add it from your Applications folder.
4. Restart Theo after granting the permission.
...
If a Theo shortcut conflicts with another application's shortcut, the behavior depends on your operating system and which app has priority. Common conflicts include:
...
- **Other recording software** - If you have other screen recording tools installed, their shortcuts may conflict with Theo's.

If you find that a shortcut is not triggering Theo, check whether another application is intercepting it first.
