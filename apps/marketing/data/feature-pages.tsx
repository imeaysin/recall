import type { FeatureItem } from "@/components/landing"
...
export const defaultFeatureGridItems: FeatureItem[] = [
  ...
  {
    href: "/transactions",
    icon: <List className="text-muted-foreground" size={24} />,
    title: "Transactions",
  ...
  {
    href: "/time-tracking",
    icon: <Timer className="text-muted-foreground" size={24} />,
    title: "Time tracking",
    description: "Project hours",
  },
  {
    href: "/customers",
    icon: <Users className="text-muted-foreground" size={24} />,
    title: "Customers",
    description: "Customer performance",
  },
  {
    href: "/file-storage",
    icon: <FolderArchive className="text-muted-foreground" size={24} />,
    title: "Files",
    description: "Document storage",
  },
  {
    href: "/pre-accounting",
    icon: <ArrowUpRight className="text-muted-foreground" size={24} />,
    title: "Exports",
    description: "Accounting ready",
  },
  {
    href: "/mcp",
    icon: <Blocks className="text-muted-foreground" size={24} />,
